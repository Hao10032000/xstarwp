...
if (class_exists('WP_Customize_Control')) {
	...
	class themesflat_Typography extends WP_Customize_Control {
		...
		public function render_content() {
			$this->titles = array(
				'100'        => esc_html__( 'Thin 100', 'xstar' ),
				'100italic'  => esc_html__( 'Thin 100 italic', 'xstar' ),
				'200'        => esc_html__( 'Extra-light 200', 'xstar' ),
				'200italic'  => esc_html__( 'Extra-light 200 italic', 'xstar' ),
				'300'        => esc_html__( 'Light 300', 'xstar' ),
				'300italic'  => esc_html__( 'Light 300 italic', 'xstar' ),
				'400'        => esc_html__( 'Normal 400', 'xstar' ),
				'400italic'  => esc_html__( 'Normal 400 italic', 'xstar' ),
				'regular'    => esc_html__( 'Normal 400', 'xstar' ),
				'italic'     => esc_html__( 'Normal 400 italic', 'xstar' ),
				'500'        => esc_html__( 'Medium 500', 'xstar' ),
				'500italic'  => esc_html__( 'Medium 500 italic', 'xstar' ),
				'600'        => esc_html__( 'Semi-bold 600', 'xstar' ),
				'600italic'  => esc_html__( 'Semi-bold 600 italic', 'xstar' ),
				'700'        => esc_html__( 'Bold 700', 'xstar' ),
				'700italic'  => esc_html__( 'Bold 700 italic', 'xstar' ),
				'800'        => esc_html__( 'Extra-bold 800', 'xstar' ),
				'800italic'  => esc_html__( 'Extra-bold 800 italic', 'xstar' ),
				'900'        => esc_html__( 'Ultra-bold 900', 'xstar' ),
				'900itallic' => esc_html__( 'Ultra-bold 900 italic', 'xstar' )
			);

			$this->titles_subsets = array(
				"cyrillic-ext"  => esc_html__("Cyrillic Extended",'xstar'),
			    "greek" 		=> esc_html__("Greek",'xstar'),
			    "greek-ext"		=>	esc_html__("Greek Extended",'xstar'),
			    "latin-ext"		=>	esc_html__("Latin Extended",'xstar'),
			    "cyrillic"		=>	esc_html__("Cyrillic",'xstar'),
			    "vietnamese"	=>	esc_html__("Vietnamese",'xstar'),
			    "latin" 		=> esc_html__("Latin",'xstar')
				);
			...
			<div class="themesflat-options-control-inputs">					
				...
				<div class="themesflat-options-control-chosen themesflat-typography-group typography-font">
					<div class="themesflat-options-control-title customize-control-title">
						<label for="<?php  echo esc_attr( $name ) ?>-family"><?php esc_html_e( 'Font Family', 'xstar' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
						<select name="<?php  echo esc_attr( $name ) ?>[family]" id="<?php  echo esc_attr( $name ) ?>-family" class="select-choosen" >
							<optgroup label="<?php echo esc_html( 'Google Fonts', 'xstar' ) ?>">
				...
				<div class="themesflat-options-control-chosen themesflat-typography-group typography-style">
					<div class="themesflat-options-control-title customize-control-title">
						<label><?php esc_html_e( 'Font Weight & Style', 'xstar' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
						<label>
				...
				<?php if ( in_array( 'subsets', $this->fields ) ): ?>
					<div class="themesflat-options-control typography-subsets themesflat-options-control-switcher active">
						<div class="themesflat-options-control-title customize-control-title">
							<label><?php esc_html_e( 'Font subsets', 'xstar' ) ?></label>
						</div>
						<div class="themesflat-options-control-inputs">
				...
				<div class="themesflat-typography-group typography-size">
					<div class="themesflat-options-control-title customize-control-title">
						<label for="<?php  echo esc_attr( $name ) ?>-size"><?php esc_html_e( 'Font Size (px)', 'xstar' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
				...
				<div class="themesflat-typography-group typography-line_height">
					<div class="themesflat-options-control-title customize-control-title">
						<label for="<?php  echo esc_attr( $name ) ?>-line_height"><?php esc_html_e( 'Line height ( ex: 25px or 1.8 or 150% )', 'xstar' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
				...
				<div class="themesflat-typography-group typography-letter_spacing">
					<div class="themesflat-options-control-title customize-control-title">
						<label for="<?php  echo esc_attr( $name ) ?>-letter_spacing"><?php esc_html_e( 'Letter Spacing ( Value in px or em )', 'xstar' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
				...
				<div class="themesflat-typography-group themesflat-options-control-color-picker typography-color">
					<div class="themesflat-options-control-title customize-control-title">
						<label><?php esc_html_e( 'Font Color', 'xstar' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
	    ...
	    public function get_fonts( $amount = 300 ) {
	        ...
	        $fonts_array = array();
			$json_dir = THEMESFLAT_DIR. 'assets/fonts';
