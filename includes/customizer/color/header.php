...
$wp_customize->add_control( new themesflat_ColorOverlay(
        ...
        array(
            ...
            'description'   => esc_html__(' Opacity =1 for Background Color', 'xstar'),
...
$wp_customize->add_control( new themesflat_ColorOverlay(
        ...
        'header_backgroundcolor_sticky',
        array(
            'label'         => esc_html__('Sticky Header Background', 'xstar'),
            'section'       => 'color_header',
            'priority'      => 2
        )
    )
...
$wp_customize->add_control(
    new themesflat_ColorOverlay(
        ...
        'mainnav_color_sticky',
        array(
            'label' => esc_html__('Menu Color on Sticky', 'xstar'),
            'section' => 'color_header',
            'priority' => 3
        )
    )
...
$wp_customize->add_control(
    new themesflat_ColorOverlay(
        ...
        'mainnav_color',
        array(
            'label' => esc_html__('Menu color', 'xstar'),
            'section' => 'color_header',
            'priority' => 4
        )
    )
...
$wp_customize->add_control(
    new themesflat_ColorOverlay(
        ...
        'mainnav_hover_color',
        array(
            'label' => esc_html__('Menu Hover & Active', 'xstar'),
            'section' => 'color_header',
            'priority' => 5
        )
    )
...
$wp_customize->add_control(
    new themesflat_ColorOverlay(
        ...
        'sub_nav_color',
        array(
            'label' => esc_html__('SubMenu color', 'xstar'),
            'section' => 'color_header',
            'priority' => 23
        )
    )
...
$wp_customize->add_control(
    new themesflat_ColorOverlay(
        ...
        'sub_nav_color_hover',
        array(
            'label' => esc_html__('SubMenu Hover & Active', 'xstar'),
            'section' => 'color_header',
            'priority' => 24
        )
    )
...
$wp_customize->add_control(
    new themesflat_ColorOverlay(
        ...
        'sub_nav_background',
        array(
            'label' => esc_html__('SubMenu Background', 'xstar'),
            'section' => 'color_header',
            'priority' => 25
        )
    )
...
$wp_customize->add_control(
    new themesflat_ColorOverlay(
        ...
        'sub_nav_background_hover',
        array(
            'label' => esc_html__('SubMenu Background Hover & Active', 'xstar'),
            'section' => 'color_header',
            'priority' => 26
        )
    )
...
$wp_customize->add_control(
    new themesflat_ColorOverlay(
        ...
        'sub_nav_border_color',
        array(
            'label' => esc_html__('SubMenu Border Line', 'xstar'),
            'section' => 'color_header',
            'priority' => 27
        )
    )
