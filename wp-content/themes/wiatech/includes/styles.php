...
function themesflat_custom_styles( $custom ) {
	...
	//GROUP HEADER
		...
		if ( $header_backgroundcolor !='' ) {
			$custom .= "#header.header-default, #header.header-02, #header.header-absolute { background:" . esc_attr($header_backgroundcolor) . ";}"."\n";
		}
    ...
    //GROUP PAGE TITLE
		...
		$custom .= ".page-title { background:" . esc_attr($page_title_background_color) . ";}"."\n";
		...
		$custom .= ".breadcrumbs span, .breadcrumbs span i, .breadcrumbs span.trail-browse i {color:" . themesflat_get_opt('breadcrumb_color') . ";}"."\n";
		
		$custom .= ".breadcrumbs span a, .breadcrumbs a span {color:" . themesflat_get_opt('breadcrumb_link_color') . ";}"."\n";
	...
	//GROUP COLOR
    	...
    	if ( $primary_color !='' ) {
			...
			$custom .= ".logged-in-as a:hover,a:hover, .comments-area ol.comment-list article .comment_content .comment_meta .comment_author a:hover, .widget.widget_block ul.wp-block-latest-posts li a:hover, .widget ul li a:hover, .widget ol li a:hover, article .entry-title a:hover,article .entry-title a:hover, .item article .entry-title a:hover { color:" . esc_attr($primary_color) . ";}"."\n";
