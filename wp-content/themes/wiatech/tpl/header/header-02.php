                ...
                <div class="inner-wrap">
                    <div class="topbar-left">
                        ...
                        <ul class="list-infor-topbar">
                            ...
                            <li></a> <i class="icon-xstar-location-dot"></i>
                                <?php echo esc_html($information_address); ?></li>
                            <?php endif;?>
                            <?php if ( $topbar_mail == 1 ) :?>
                            <li> <a href="mailto:<?php echo esc_attr($information_email); ?>"><i
                                        class="icon-xstar-envelope"></i> <?php echo esc_html($information_email); ?></a>
                            </li>
                            <?php endif;?>
                        </ul>
                        <?php endif;?>
