                    ...
                    <div class="topbar-left">
                        ...
                        <ul class="list-infor-topbar">
                            <?php if ( $topbar_address == 1 ) :?>
                                <li></a> <i class="icon-xstar-location-dot"></i> <?php echo esc_html($information_address); ?></li>
                            <?php endif;?>
                            <?php if ( $topbar_mail == 1 ) :?>
                                <li> <a href="mailto:<?php echo esc_attr($information_email); ?>"><i class="icon-xstar-envelope"></i> <?php echo esc_html($information_email); ?></a></li>
                            <?php endif;?>
                        </ul>
                        <?php endif;?>
                    </div>
                    ...
                    <?php if( $header_button == 1 || $header_infor_phone == 1): ?>
                        <div class="header-ct-right">
                            <?php if ( $header_infor_phone == 1 ) :?>
                                ...
                                <?php echo esc_html($information_phone); ?></a>
                            <?php endif;?>     
